...
function isCrash(bird,pipe) {
    return! (
        ...
        bird.offsetTop+flyBird.offsetHeight<pipe.offsetTop||
...
function init() {
    start.onclick=function (event) {
        ...
        if(event.stopPropagation){//不同浏览器对于事件冒泡的处理不同，判断该浏览器支持哪种方法，用不同方法去取消事件冒泡
